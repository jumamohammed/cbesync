...
class Cat(models.Model):
    ...
    #2. cat foreign keys, course, class, subject and teache
    ...
    cat_teacher = models.ForeignKey('teachers.Teacher', to_field='teacher_id', null= True, on_delete=models.SET_NULL, related_name='cats', help_text="Teacher associated with the cat")
    #3.cat name
    ...
    #5. cat max_score
    # cat_score = models.PositiveIntegerField( default=0, help_text="Cat score")
