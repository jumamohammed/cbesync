...
class Exam(models.Model):
    ...
    exam_type = models.CharField(max_length=20, db_index=True, choices=EXAM_TYPE_CHOICES, default='Internal', help_text="Exam type e.g zonal")
        # exam_score = models.PositiveIntegerField(default=0, help_text="Exam score.")
    exam_max_score = models.PositiveIntegerField(default=0, help_text="Maximum possible score.")
        # exam_percentage_score = models.PositiveIntegerField(default=0, help_text="Exam score.")
    #6. Status
